  ...
  return (
    ...
    >
      {isDashboardPage ? (
        ...
        <div className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-[calc(100%-2rem)] max-w-6xl bg-white/10 backdrop-blur-md ${isMobileMenuOpen ? 'rounded-2xl' : 'rounded-full'}`}>
          <div className="px-6 py-4">
            <div className="flex justify-between items-center">
              {/* Logo/Brand */}
              <Link to={user ? "/dashboard" : "/"} className="text-white text-2xl font-bold hover:text-white/80 transition-colors">
            ...
            {isMobileMenuOpen && (
              <div className="md:hidden border-t border-white/20 mt-4 pt-4 h-[80vh] flex flex-col justify-center items-center">
                <div className="flex flex-col space-y-8 items-center">
                  {/* Big Title */}
                  <h1 className="text-white text-center leading-tight px-4" style={{ fontSize: '3rem', fontWeight: 'medium' }}>
