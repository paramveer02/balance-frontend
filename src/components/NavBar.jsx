            ...
            <div className="flex justify-between items-center w-full">
              ...
              <div className="hidden md:block">
                <div className="flex items-center space-x-4">
                  ...
                  {user && (
                    <button className="navbar-tab-text relative text-gray-700 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white transition-colors duration-200 group">
                      Report
                      <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-green-500 group-hover:w-full transition-all duration-300 ease-out"></span>
                    </button>
                  )}
