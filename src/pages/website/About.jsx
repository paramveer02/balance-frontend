...
const About = () => {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-green-50">
      ...
      <section className="relative min-h-screen bg-black flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-4xl mx-auto text-center px-6 py-20">
          ...
          <p className="text-lg md:text-xl text-white/90 leading-relaxed mb-12 max-w-2xl mx-auto">
            Transform your daily routines into engaging experiences with our AI-powered health tracking platform. 
            Make every step count towards a better you.
          </p>
        </div>
      ...
      {/* Our Team Section */}
      <section ref={teamSectionRef} className="py-20 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">Our Team</h1>
